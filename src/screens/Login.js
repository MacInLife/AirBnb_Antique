...
const ErrorMessages = {
  ...
  [ERR_LOGIN_INVALID]:
    'Identification impossible : le couple email/mot de passe est introuvable.',
};
    ...
    header: () => (
      <View style={stylesCo.containerConnect}>
        <TouchableOpacity onPress={() => navigation.goBack()}>
          <Icon size={20} style={stylesCo.iconclose} name="arrow-left" />
        </TouchableOpacity>
    ...
    return (
      <View style={stylesCo.structGlobal}>
        ...
        <View
          ...
          <TouchableOpacity disabled={!isValidEmail} onPress={this.login}>
            <Icon
              size={35}
              style={isValidEmail ? stylesCo.icongo : {color: 'gray'}}
              name="angle-right"
            />
          </TouchableOpacity>
        </View>
